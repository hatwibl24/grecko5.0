     ...
     <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
           <Card className="p-6">
              ...
              <form onSubmit={handleAdd} className="flex flex-col md:flex-row gap-2 mb-6"><Input placeholder="Add new task..." value={newAssignment} onChange={(e) => setNewAssignment(e.target.value)} className="flex-1" /><Input type="date" value={dueDate} onChange={(e) => setDueDate(e.target.value)} className="w-full md:w-40" /><Button type="submit" size="sm" icon={<Plus className="w-4 h-4"/>} className="w-full md:w-auto">Add</Button></form>
